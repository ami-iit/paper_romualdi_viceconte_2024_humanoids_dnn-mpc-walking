...
#ifndef CENTROIDAL_MPC_WALKING_CENTROIDAL_MPC_H
#define CENTROIDAL_MPC_WALKING_CENTROIDAL_MPC_H
...
struct CentroidalMPCOutput
{
    ...
    BipedalLocomotion::Contacts::ContactPhaseList contactPhaseList; /**< Contact phase list generated by the
                                                    CentroidalMPC. */
 ...
 */
class CentroidalMPC : public BipedalLocomotion::System::Source<CentroidalMPCOutput>
{
public:
    /**
     * Constructor.
     ...
     */
    bool setContactPhaseList(const BipedalLocomotion::Contacts::ContactPhaseList& contactPhaseList);
    ...
    bool setState(Eigen::Ref<const Eigen::Vector3d> com,
                  Eigen::Ref<const Eigen::Vector3d> dcom,
                  Eigen::Ref<const Eigen::Vector3d> angularMomentum,
                  const BipedalLocomotion::Math::Wrenchd& externalWrench,
                  const std::unordered_map<std::string, std::vector<bool>>& cornerStatus = {});
...
#endif // CENTROIDAL_MPC_WALKING_CENTROIDAL_MPC_H
