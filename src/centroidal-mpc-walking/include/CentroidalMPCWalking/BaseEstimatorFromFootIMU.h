...
#ifndef CENTROIDAL_MPC_WALKING_BASE_ESTIMATION_FROM_FOOT_IMU_H
#define CENTROIDAL_MPC_WALKING_BASE_ESTIMATION_FROM_FOOT_IMU_H
...
#endif // CENTROIDAL_MPC_WALKING_BASE_ESTIMATION_FROM_FOOT_IMU_H
